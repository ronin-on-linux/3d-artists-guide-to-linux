...
Export using OpenEXR ro MultiLayer EXR.
### Blender AgX EXR to Rec709 (1:1 Blender Viewport w/ Full Color Gamut)
...
### Blender ACEScg/ACES 2.0 EXR to Rec709 (Industry VFX Standard)
...
### Houdini EXR
I have never had to change the color space of the EXR files from Houdini, but when I learn how to define the color space as ACES or Linear, I will update this here.