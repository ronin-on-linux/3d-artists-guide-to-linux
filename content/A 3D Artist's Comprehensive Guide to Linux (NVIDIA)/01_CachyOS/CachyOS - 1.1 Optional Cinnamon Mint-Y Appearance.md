...
1. Install `pacman -S mint-themes mint-y-icons` to enable the simplified appearance menu in the cinnamon settings. (It will take a while to download and install)
