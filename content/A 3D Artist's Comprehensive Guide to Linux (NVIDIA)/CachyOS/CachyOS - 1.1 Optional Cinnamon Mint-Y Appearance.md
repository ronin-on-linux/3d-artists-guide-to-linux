...
1. Install `paru -S cinnamon-styles-artwork` to enable the simplified appearance menu in the cinnamon settings. (It will take a while to download and install)
	- `paru -S bibata-cursor-theme` to install better looking cursor if it doesn't come in step 1 (IT SHOULD)
